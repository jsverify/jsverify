...
function shrinkSum(shrinks) {
  ...
  var result = shrinkBless(function (s) {
    return s.fold(function (idx, n, value) {
      assert(n === shrinks.length, "shrinkSum: not-matching params");
      return shrinks[n](value).map(function (shrinked) {
        return sum.append(idx, n, shrinked);
      });
    });
  });
